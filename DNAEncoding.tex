...
\begin{table}[!t]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|}\hline \hline
		Method  &Organism  &Bio-Restrictions*  &Error Detection/Correction  &Error Rate  &Compression Technique  &Bits/Base Density  &Encryption  &Blind Decoding\\ \hline
		Protein Coding DNA  &  &  &  &  &  &  &  &\\ \hline
		Secret Signature~\cite{AY2004BP}  &B. subtilis  &H,S,F,(),()  &Parity Bit / -  &*  &None  &6 Bases / Letter  &None  &No\\ \hline
		DNA-Crypt~\cite{HBBMC2007}  &S. cerevisiae  &H,S,F,(),()  &WDH, Hamming  &*  &None  &0.214  &OTP, AES, Blowfish, RSA  &No\\ \hline
		  &  &  &  &  &  &  &  &\\ \hline
		Noncoding DNA  &  &  &  &  &  &  &  &\\ \hline
		  &  &  &  &  &  &  &  &\\ \hline
		  &  &  &  &  &  &  &  &\\ \hline
