...
\begin{table*}[t]
	...
	\multirow{1}{*}{\vspace{0cm}\textbf{pcDNA}} & Secret Signature~\cite{AY2004BP}  &\centering{$\CIRCLE$}  &\centering{$\CIRCLE$}  &  &  &\centering{$\CIRCLE$}  &  &  &  &\\ \hline
        ...
        \multirow{1}{*}{\vspace{0cm}\textbf{ncDNA and Plasmids}} &Organic Memory~\cite{WWF2003COTACM}  &  &  &\centering{$\CIRCLE$}  &  &  &  &  &  &$\CIRCLE$\\ \hline
