...
\title{Data Storage in Cellular DNA: Contextualizing Diverse Encoding Schemes}
\author[Sample \textit{et~al}.]{Anthony P. Machado\,$^{\text{}}$, Gaby G. Dagher\,$^{\text{}}$, and Eddie C. Davis\,$^{\text{}}$}
\address{$^{\text{}}$Computer Science Department, Boise State University, Boise, 83725, USA}
...
\begin{table*}[t]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|}\hline \hline
		& \multirow{2}{*}{\textbf{Scheme}}  &\multicolumn{4}{|c|}{\textbf{Bio-Restrictions Satisfied}}  &\multicolumn{5}{|c|}{\textbf{Scheme Components}}\\ \cline{3-11}
	...
	\multirow{6}{*}{pcDNA} & Secret Signature~\cite{AY2004BP}  &\centering{$\CIRCLE$}  &\centering{$\CIRCLE$}  &  &  &\centering{$\CIRCLE$}  &  &  &  &\\ \cline{2-11}
		...
		&DWT Based~\cite{L2014IS}  &\centering{$\CIRCLE$}  &\centering{$\CIRCLE$}  &\centering{$\CIRCLE$}  &\centering{$\CIRCLE$}  &  &  &  &  &\\ \cline{2-11}
        &LSBase~\cite{KH2015BJOMACS}  &\centering{$\CIRCLE$}  &\centering{$\CIRCLE$} &  &  &  &  &  &  &$\CIRCLE$\\ \hline
        \multirow{7}{*}{ncDNA \& Plasmids} &Organic Memory~\cite{WWF2003COTACM}  &  &  &\centering{$\CIRCLE$}  &  &  &  &  &  &$\CIRCLE$\\ \cline{2-11}
...
\begin{table*}[t]
	\caption{Details of Scheme Implementation}
	\label{fig:table3}
	\centering
	\scalebox{0.9}{
	\begin{tabular}{|c|c|c|c|c|c|c|}\hline \hline
		 &\textbf{Scheme} &\textbf{Organism} &\textbf{Method} &\textbf{Data}  &\textbf{Density} $^\dagger$ &\textbf{Error Detection/Correction} \\ \hline
	\multirow{6}{*}{pcDNA} & Secret Signature  &Bacteria &In vivo &"KEIO"  &0.167 cpc &Parity bit \\ \cline{2-7}
		&DNA-Crypt &Bacteria &In silico  &"this is a test"  &0.173 bpc &Hamming, WDH\\ \cline{2-7}
        &Codon Usage Table  &Bacteria, yeast, plant, human &In vivo  &"GENE" &0.143 bpc  &None  \\ \cline{2-7}
		&BioCode  &Bacteria, yeast &In silico  &"BioCode preserves codon bias"  &0.204 bpc  &Hamming, Repetition  \\ \cline{2-7}
		&DWT Based  &Bacteria, yeast, human  &In silico  &N/A  &0.180 bpc  &None  \\ \cline{2-7}
        &LSBase  &Rodent &In silico  &3.7 kb text  &0.333 bpn  &None  \\ \hline
        \multirow{7}{*}{ncDNA \& Plasmids} &Organic Memory  &Bacteria  &In vivo  &"It's a Small World" lyrics  &0.333 cpn  &None \\ \cline{2-7}
		&Alignment-Based &Bacteria  &In vivo &"E=mc2"  &0.5 bpn &Repetition  \\ \cline{2-7}
		&Improved Huffman  &Theoretical &In silico  &Lyrics, music \& image  &0.286 bpn  &None  \\ \cline{2-7}
		&RAlign  &Virus  &In silico  &1000 bits &0.48 bpn  &Repetition  \\ \cline{2-7}
		&HTAlign  &Virus  &In silico  &1000 bits  &0.46 bpn &Repetition  \\ \cline{2-7}
		&DNA Barcodes  &Theoretical  &In silico  &73 code sets &0.2 bpn  &Hamming  \\ \cline{2-7}
		&DNA-Courier Attack  &Bacteria  &In silico  &"HelloMyNameIsLHL"  &0.97 bpn  &None  \\ \hline
	\end{tabular}}
    \vspace{0.01cm}
    \newline
    $\dagger$
    \fontsize{7pt}{12pt}\selectfont
    \raggedright In this column, cpc denotes "characters per nucleotide", bpc denotes "bits per codon", and bpn denotes "bits per nucleotide". In the case of multiple storage sites, the average density is taken.
\end{table*}
